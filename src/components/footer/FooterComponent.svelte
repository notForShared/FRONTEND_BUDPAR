...
<div class="__footer">
  <div class="border-y px-10 lg:px-36 py-12 border-[#e6e6e6]">
    ...
    >
      ...
      <div class="w-full text-center md:text-left lg:text-center pt-12 md:pt-0">
        ...
        <div
          class="__user-count flex justify-center md:justify-start lg:justify-center pt-5"
        >
          <a href="https://info.flagcounter.com/gBbb">
            <img
              src="https://s01.flagcounter.com/count2/gBbb/bg_FFFFFF/txt_000000/border_CCCCCC/columns_3/maxflags_12/viewers_3/labels_1/pageviews_0/flags_0/percent_0/"
              alt="Flag Counter"
              border="0"
            />
          </a>
  ...
  <div class="__copyright text-center py-3">
    <div class="text-[13px] capitalize text-[#6e7074]">
      ...
      <a href="http://disbudpar.tapinkab.go.id/" class="hover:underline">
        DISBUDPAR
      </a>
      <span>Kab. Tapin</span>
    </div>
